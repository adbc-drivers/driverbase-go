...
require (
	github.com/adbc-drivers/driverbase-go/driverbase v0.0.0-20260614222945-5966df88680b
	github.com/adbc-drivers/driverbase-go/testutil v0.0.0-20260614222945-5966df88680b
